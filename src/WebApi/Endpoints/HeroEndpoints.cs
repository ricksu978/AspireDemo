using MediatR;
using AspireDemo.Application.UseCases.Heroes.Commands.CreateHero;
using AspireDemo.Application.UseCases.Heroes.Commands.UpdateHero;
using AspireDemo.Application.UseCases.Heroes.Queries.GetAllHeroes;
